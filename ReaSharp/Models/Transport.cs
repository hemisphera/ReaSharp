...
public class Transport
{
  ...
  public TimeSpan CursorPosition
  {
    ...
    set
    {
      ...
      Reaper.SetEditCurPos2(_project.ReaperHandle, _cursorPosition.TotalSeconds, false, false);
    }
  }
  ...
  public void Update()
  {
    ...
    _cursorPosition = TimeSpan.FromSeconds(Reaper.GetCursorPositionEx(_project.ReaperHandle));
    _playState = Reaper.GetPlayStateEx(_project.ReaperHandle);
    PlayheadBeatsPosition = BeatPosition.FromTime(PlayheadPosition, _project);
    CursorBeatsPosition = BeatPosition.FromTime(CursorPosition, _project);
  }
}